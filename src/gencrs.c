/**
 * The program converts a sparse matrix file from COO to CRS format(.mat -> .crs)
 * USAGE:
 *        [-i inputfile] [-o outputfile] [-h]
 *        example for a chain with 4 sites (n = 4): ./gencrs -i test_n_4.mat -o test_n_4.crs 
**/
...
int main(int argc, char *argv[])
{
  ...
  int of_found = 0;
  FILE *f;
  uint64_t * col, *col_new, * row, * row_ptr, * hist;
  double * val, * val_new;
